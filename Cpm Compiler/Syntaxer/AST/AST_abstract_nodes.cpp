#include "Cpm_headers\AST_abstract_nodes.hpp"
#include "Cpm_headers\AST_nodes.hpp"
#include "Cpm_headers\compiler_errors.hpp"

AST_abstract_node::AST_abstract_node(const token& data, AST_abstract_node* parent = nullptr) : data(data),  parent(parent){}
